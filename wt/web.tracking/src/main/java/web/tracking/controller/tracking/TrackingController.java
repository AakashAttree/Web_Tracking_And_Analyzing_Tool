...
import web.tracking.producer.Producer;
...
public class TrackingController {
  ...
  public void saveTask(@RequestBody(required = false) Object obj, HttpServletRequest httpServletRequest,
      ...
      synchronized (httpSession) {
        ...
        if(trackingData != null) {
          if(trackingData.isClosed()) {
            ...
            Cookie cookie = new Cookie(TrackingConstants.SESSION_ID, sessionId);
            response.addCookie(cookie);
            trackingData.setSessionId(null);
          }
          else {
  ...
  private void setDetails(HttpServletRequest httpServletRequest, Map<String, Object> map) {
